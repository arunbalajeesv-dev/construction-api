...
async function verifyOtp(req, res) {
  ...
  const token = signToken({ phone: normalized, type: 'signup' }, '1h');
  return res.json({ success: true, isNewUser: true, token, phone: normalized });
}
...
module.exports = { syncAuth, sendOtp, verifyOtp, resendOtp };
